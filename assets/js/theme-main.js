...
$(document).ready(function($) {
    ...
    $('#event-one').countdown('2024/11/15', function(event) {
      var $this = $(this).html(event.strftime(''
      + '<span>%D <br> <small>Nap</small></span>  '
      + '<span>%H <br> <small>Óra</small> </span>  '
      + '<span>%M <br> <small>Perc</small> </span>  '
      + '<span>%S <br> <small>m.p.</small></span> '));
